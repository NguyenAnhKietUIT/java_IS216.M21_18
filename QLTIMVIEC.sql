...
--Tao bang INTERVIEWER_SCHEDULE va khoa chinh
CREATE TABLE INTERVIEWER_SCHEDULE
(
...
ALTER TABLE INTERVIEWER_SCHEDULE ADD CONSTRAINT PK_INTERVIEWER_SCHEDULE PRIMARY KEY (interviewScheduleNo)
GO
...
--9. Bang INTERVIEWER_SCHEDULE
INSERT INTO INTERVIEWER_SCHEDULE VALUES ('13/1/2021', ' 15/1/2021' , N'71 Đinh Tiên Hoàng' , 0 , 20, 1)
INSERT INTO INTERVIEWER_SCHEDULE VALUES ('13/2/2021', ' 19/2/2021' , N'65/6 Hà Tôn Quyền' , 1 , 18, 2)
INSERT INTO INTERVIEWER_SCHEDULE VALUES ('26/1/2021', ' 5/2/2021' , N'15 Nguyễn Tri Phương' , 0 , 50, 2)
INSERT INTO INTERVIEWER_SCHEDULE VALUES ('13/1/2021', ' 19/1/2021' , N'72 Hồ Tùng Mậu' , 0 , 21, 4)
INSERT INTO INTERVIEWER_SCHEDULE VALUES ('21/3/2021', ' 5/4/2021' , N'79/5/1 Nguyễn Thái Học' , 0 , 30, 5)
GO
...
--Bang INTERVIEWER_SCHEDULE
ALTER TABLE INTERVIEWER_SCHEDULE ADD CONSTRAINT FK_INTERVIEWER_SCHEDULE FOREIGN KEY (interviewerNo) REFERENCES INTERVIEWER (interviewerNo)
GO
...
SELECT * FROM INTERVIEWER_SCHEDULE
